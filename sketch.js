...
var ground;
var music , trophySound , transitionSound , victorySound,hitSound,gameOverSound;
...
gameOverSound = loadSound("gamelost.mp3");
}
...
function spawnBrickWalls(){
  ...
  function spawnObstacles(){
    var randomFrameCount = Math.round(random(250,500));
    if(frameCount % randomFrameCount === 0){
    ...
    function spawnTrophies(){
      var randomFrameCount = Math.round(random(300,400));
    if(frameCount % randomFrameCount === 0){
